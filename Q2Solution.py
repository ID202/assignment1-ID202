...
def determine_mushroom():
    gills = input("Does your mushroom have gills? (yes/no): \n").lower()

    forest = input("Does your mushroom grow in a forest? (yes/no): \n").lower()

    ring = input("Does your mushroom have a ring? (yes/no): \n").lower()
